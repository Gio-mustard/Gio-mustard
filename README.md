...
Soy un desarrollador backend con más de 3 años de experiencia en Python y Django. Mi enfoque es crear soluciones eficientes, diseñar APIs web y optimizar el rendimiento. He desarrollado aplicaciones de escritorio para la automatización de procesos y sistemas web que incluyen autenticación de usuarios y gestión de archivos.
